# [full stack apache2 webserver for everyone with docker compose](https://github.com/damalis/full-stack-apache2-webserver-for-everyone-with-docker-compose)

If You want to have a webserver at short time; 

#### Full stack Apache2 Webserver:
...
```
git clone https://github.com/damalis/full-stack-apache2-webserver-for-everyone-with-docker-compose.git
```

Open a terminal and `cd` to the folder in which `docker-compose.yml` is saved and run:

```
cd full-stack-apache2-webserver-for-everyone-with-docker-compose
chmod +x install.sh
./install.sh
```
